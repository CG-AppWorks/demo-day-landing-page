    ...
    <section className="section bone" id="agenda">
      <div className="container">
        <div className="section-head">
          <div>
            <div className="eyebrow">Today's run of show</div>
            <h2>Agenda.</h2>
            <p className="sub">Approximate timing — segments may shift on the day.</p>
          </div>
        </div>
  ...
  return (
    <section className="section" id="album">
      <div className="container">
        <div className="section-head">
          <div>
            <div className="eyebrow">Live photography · powered by Accupai</div>
            <h2>Live photo album.</h2>
            <p className="sub">Real-time event photography from the floor — view, download, and share on the spot. 透過 Accupai 即時看看活動照片。</p>
          </div>
...
function About() {
  const cards = [
    ...
    },
    {
      ...
      zh: "於 2010 年創辦，每半年選拔最具潛力的早期新創團隊。",
  ...
  return (
    <section className="section" id="about">
      <div className="container">
        <div className="section-head">
          <div>
            <div className="eyebrow">Since 2009 · By Founders, For Founders</div>
            <h2>About AppWorks.</h2>
            <p className="sub">An accelerator, a community, and a fund — built by founders, for founders.</p>
          </div>
        </div>
  ...
  return (
    <section className="section bone" id="partners">
      <div className="container">
        <div className="section-head">
          <div>
            <div className="eyebrow">Corporate accelerator partner</div>
            <h2>Wistron Accelerator #10.</h2>
            <p className="sub">A corporate partner bringing manufacturing, global distribution, and deep-tech GTM to the Demo Day stage. 4 WA#10 teams pitch right after the AppWorks cohort.</p>
          </div>
        </div>
    ...
    <section className="section tight" id="sponsors">
      <div className="container">
        <div className="section-head">
          ...
          <button className="btn outline sm">Become a sponsor <I.arrow/></button>
        </div>
        <div className="sponsors two">
          {sponsors.map((s, i) => <div key={i} className="sp">{s}</div>)}
        </div>
      </div>
    </section>
  );
...
I'm connecting after attending AppWorks #32 + Wistron #10 Demo Day in Taipei. Your pitch — "${team.pitch}" — resonated with us, and we'd love to explore working together.
